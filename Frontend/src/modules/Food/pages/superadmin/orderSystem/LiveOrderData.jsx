...
export const liveOrderStats = {
  activeOrders: { count: 42, trend: "+5%" },
  preparing: { count: 18 },
  delivery: { count: 15 },
  criticalAlerts: { count: 4 }
};

export const liveOrders = {
  new: [
    { id: '#ORD-4612', time: '2m ago', items: '1x Veg Supreme, 2x Coke', type: 'REGULAR', price: '₹24.50' },
    { id: '#ORD-4611', time: '5m ago', items: '2x Paneer Tikka Pizza', type: 'VIP', price: '₹32.00' }
  ],
  preparing: [
    { id: '#ORD-4605', timeInPrep: '8m in prep', items: '3x Farm Fresh Deluxe', progress: '66%' }
  ],
  ready: [
    { id: '#ORD-4598', items: '1x Garden Special, 1x Garlic Bread' }
  ],
  delivery: [
    { id: '#ORD-4580', eta: '4 mins', rider: 'Mike T.', distance: '2.4 miles away' }
  ]
};
