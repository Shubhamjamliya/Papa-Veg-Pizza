...
export default function StoreOperationalDetails({ isOpen, onClose, storeName }) {
  ...
  return (
    <>
      ...
      <div className={`fixed inset-y-0 right-0 w-full md:w-[500px] bg-white dark:bg-zinc-950 shadow-2xl z-[70] transform transition-transform duration-300 flex flex-col ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        
        {/* Header */}
        <div className="px-6 py-5 border-b border-zinc-200 dark:border-zinc-800 flex items-center justify-between bg-zinc-50 dark:bg-zinc-950">
          <div>
            <h2 className="text-xl font-bold text-zinc-900 dark:text-zinc-50">{storeName || 'Downtown Manhattan #402'}</h2>
            <p className="text-xs font-bold text-zinc-500 uppercase tracking-wider mt-1">Store Operational Profile</p>
          </div>
          <button 
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto p-6 scrollbar-none">
          ...
          <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-5 mb-6 shadow-sm">
            ...
            <div className="flex gap-4">
              <div className="flex-1 bg-zinc-50 dark:bg-zinc-950 rounded-xl p-4 border border-zinc-100 dark:border-zinc-800">
                <p className="text-[10px] font-bold text-zinc-500 uppercase tracking-wider flex items-center gap-1.5 mb-2">
                  <ShoppingCart size={14} />
                  Live Orders
                </p>
                <p className="text-3xl font-black text-[var(--primary)]">42</p>
              </div>
              <div className="flex-1 bg-zinc-50 dark:bg-zinc-950 rounded-xl p-4 border border-zinc-100 dark:border-zinc-800">
                <p className="text-[10px] font-bold text-zinc-500 uppercase tracking-wider flex items-center gap-1.5 mb-2">
                  <Users size={14} />
                ...
                <p className="text-3xl font-black text-[var(--primary)]">18</p>
              </div>
            </div>
          </div>

          {/* Tab Navigation */}
          <nav className="flex border-b border-zinc-200 dark:border-zinc-800 mb-6 overflow-x-auto scrollbar-none relative">
            {tabs.map(tab => (
              <button
                key={tab.id}
                onClick={() => setActiveTab(tab.id)}
                className={`flex-shrink-0 px-5 py-3 text-xs font-bold uppercase tracking-wider transition-colors relative ${
                  activeTab === tab.id 
                    ? 'text-[var(--primary)]' 
          ...
          <div className="space-y-6">
            ...
            {activeTab === 'overview' && (
              <div className="animate-fade-in space-y-6">
                <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-5">
                  <h3 className="text-[10px] font-bold text-zinc-500 uppercase tracking-wider mb-5">Delivery Time vs. Customer Rating</h3>
                  <div className="relative h-48 w-full border-l border-b border-zinc-200 dark:border-zinc-800 flex items-end justify-between px-2 pb-2">
                  ...
                  <p className="mt-8 text-xs font-medium text-zinc-500 italic">Strong negative correlation: ratings drop significantly after 35 mins.</p>
                </div>

                <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-5">
                  <h3 className="text-[10px] font-bold text-zinc-500 uppercase tracking-wider mb-5">Complaints Breakdown</h3>
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      <span className="text-sm font-bold text-zinc-700 dark:text-zinc-300 w-28">Cold Food</span>
                      <div className="flex-1 flex items-center gap-3">
                        <div className="flex-1 h-2 bg-zinc-100 dark:bg-zinc-800 rounded-full overflow-hidden">
                          <div className="w-[65%] h-full bg-rose-500 rounded-full"></div>
                        </div>
                        <span className="font-mono text-sm font-black w-10 text-zinc-900 dark:text-zinc-100">42%</span>
                      </div>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-sm font-bold text-zinc-700 dark:text-zinc-300 w-28">Late Delivery</span>
                      <div className="flex-1 flex items-center gap-3">
                        <div className="flex-1 h-2 bg-zinc-100 dark:bg-zinc-800 rounded-full overflow-hidden">
                          <div className="w-[30%] h-full bg-[var(--primary)] rounded-full"></div>
                        </div>
                        <span className="font-mono text-sm font-black w-10 text-zinc-900 dark:text-zinc-100">18%</span>
                      </div>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-sm font-bold text-zinc-700 dark:text-zinc-300 w-28">Missing Items</span>
                      <div className="flex-1 flex items-center gap-3">
                        <div className="flex-1 h-2 bg-zinc-100 dark:bg-zinc-800 rounded-full overflow-hidden">
                          <div className="w-[12%] h-full bg-[var(--primary)]/60 rounded-full"></div>
                        </div>
                        <span className="font-mono text-sm font-black w-10 text-zinc-900 dark:text-zinc-100">12%</span>
                      </div>
                    </div>
                  </div>
                  <div className="mt-6 pt-5 border-t border-zinc-200 dark:border-zinc-800 flex justify-between items-center">
                    <span className="text-[10px] font-bold text-zinc-500 uppercase tracking-wider">Avg Resolution Time</span>
                    <span className="text-2xl font-black text-[var(--primary)]">14m</span>
                  </div>
                </div>
              </div>
            )}
            ...
            {activeTab === 'kitchen' && (
              <div className="animate-fade-in space-y-6">
                <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-5">
                  <h3 className="text-[10px] font-bold text-zinc-500 uppercase tracking-wider mb-5">Pizza Prep Time Trend</h3>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-rose-50 dark:bg-rose-950/20 border border-rose-100 dark:border-rose-900/30 rounded-2xl p-4">
                    ...
                    <p className="text-3xl font-black text-rose-600 dark:text-rose-500">12</p>
                  </div>
                  <div className="bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-4">
                    ...
                    <p className="text-3xl font-black text-[var(--primary)]">8</p>
                  </div>
                </div>
                ...
                <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-5">
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center justify-between p-3 hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors rounded-xl border border-transparent hover:border-zinc-200 dark:hover:border-zinc-800">
                      <div className="flex items-center gap-3">
                        <Utensils size={16} className="text-zinc-400" />
                        <span className="text-sm font-bold text-zinc-700 dark:text-zinc-300">Mozzarella Cheese</span>
                      </div>
                      <span className="font-mono text-sm font-black text-[var(--primary)]">142kg</span>
                    </div>
                    <div className="flex items-center justify-between p-3 hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors rounded-xl border border-transparent hover:border-zinc-200 dark:hover:border-zinc-800">
                      <div className="flex items-center gap-3">
                        <Croissant size={16} className="text-zinc-400" />
                        <span className="text-sm font-bold text-zinc-700 dark:text-zinc-300">Wheat Dough</span>
                      </div>
                      <span className="font-mono text-sm font-black text-[var(--primary)]">210 units</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {activeTab === 'delivery' && (
              <div className="animate-fade-in space-y-6">
                <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl overflow-hidden shadow-sm">
                  <div className="p-5 bg-zinc-50 dark:bg-zinc-950 border-b border-zinc-200 dark:border-zinc-800 flex items-center gap-2">
                  ...
                  <table className="w-full text-left">
                    <thead>
                      <tr className="bg-white dark:bg-zinc-900 border-b border-zinc-100 dark:border-zinc-800/50">
                        <th className="p-4 text-[10px] font-bold text-zinc-400 uppercase tracking-wider">Rider Name</th>
                        <th className="p-4 text-[10px] font-bold text-zinc-400 uppercase tracking-wider text-center">Deliv.</th>
                        <th className="p-4 text-[10px] font-bold text-zinc-400 uppercase tracking-wider text-right">Avg Time</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-zinc-100 dark:divide-zinc-800/50">
                      <tr>
                        <td className="p-4 text-sm font-bold text-zinc-900 dark:text-zinc-100">Marcus R.</td>
                        <td className="p-4 text-center font-mono text-sm font-black text-zinc-700 dark:text-zinc-300">14</td>
                        <td className="p-4 text-right font-mono text-sm font-black text-[var(--primary)]">18m</td>
                      </tr>
                      <tr>
                        <td className="p-4 text-sm font-bold text-zinc-900 dark:text-zinc-100">Sarah K.</td>
                        <td className="p-4 text-center font-mono text-sm font-black text-zinc-700 dark:text-zinc-300">12</td>
                        <td className="p-4 text-right font-mono text-sm font-black text-[var(--primary)]">22m</td>
                      </tr>
                      <tr>
                        <td className="p-4 text-sm font-bold text-zinc-900 dark:text-zinc-100">John D.</td>
                        <td className="p-4 text-center font-mono text-sm font-black text-zinc-700 dark:text-zinc-300">9</td>
                        <td className="p-4 text-right font-mono text-sm font-black text-rose-500">34m</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                ...
                <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-5">
                  <h3 className="text-[10px] font-bold text-zinc-500 uppercase tracking-wider mb-5 flex items-center gap-2">
                  ...
                  <div className="relative w-full aspect-square bg-zinc-50 dark:bg-zinc-950 rounded-xl overflow-hidden flex items-center justify-center border border-zinc-200 dark:border-zinc-800">
                    ...
                    <div className="grid grid-cols-2 grid-rows-2 w-full h-full p-3 gap-3 relative z-10">
            ...
            {activeTab === 'inventory' && (
              <div className="animate-fade-in space-y-6">
                <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-5">
                  <h3 className="text-[10px] font-bold text-zinc-500 uppercase tracking-wider mb-5">Stockout Analysis</h3>
                  
                  <div className="bg-rose-50 dark:bg-rose-950/30 border border-rose-200 dark:border-rose-900/50 p-4 rounded-xl flex items-center gap-4 mb-6 shadow-sm">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-4">
                      <div className="flex-1 bg-zinc-50 dark:bg-zinc-950 border border-zinc-100 dark:border-zinc-800 rounded-xl p-4 flex flex-col items-center justify-center">
                        <span className="text-3xl font-black text-[var(--primary)] mb-1">18</span>
                        <span className="text-[10px] font-bold text-zinc-500 uppercase tracking-wider">Today</span>
                      </div>
                      <div className="flex-1 bg-zinc-50 dark:bg-zinc-950 border border-zinc-100 dark:border-zinc-800 rounded-xl p-4 flex flex-col items-center justify-center">
                        <span className="text-3xl font-black text-rose-500 mb-1">4%</span>
                ...
                <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-5">
                  ...
                  <div className="space-y-2.5">
                    <div className="flex items-center justify-between p-3 border border-zinc-200 dark:border-zinc-800 rounded-xl">
                      <span className="text-sm font-bold text-zinc-800 dark:text-zinc-200">Mushrooms</span>
                    ...
                    <div className="flex items-center justify-between p-3 border border-zinc-200 dark:border-zinc-800 rounded-xl">
                      <span className="text-sm font-bold text-zinc-800 dark:text-zinc-200">Black Olives</span>
                    ...
                    <div className="flex items-center justify-between p-3 border border-rose-200 dark:border-rose-900/50 bg-rose-50/50 dark:bg-rose-950/10 rounded-xl">
                      <span className="text-sm font-bold text-zinc-800 dark:text-zinc-200">Onions</span>
