  ...
  return (
    <div className="animate-fade-in space-y-4 mt-4">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-3">
        <div>
          <h2 className="text-base md:text-lg font-bold text-zinc-900 dark:text-zinc-50">Loyalty Analytics</h2>
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button className="flex items-center gap-1.5 border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 rounded-lg px-3 py-1.5 text-[10px] font-bold uppercase tracking-wider text-zinc-600 dark:text-zinc-400 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors shadow-sm">
            <Calendar size={13} />
            Date Range
          </button>
          <button className="flex items-center gap-1.5 border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 rounded-lg px-3 py-1.5 text-[10px] font-bold uppercase tracking-wider text-zinc-600 dark:text-zinc-400 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors shadow-sm">
      ...
      <div className="bg-zinc-950 dark:bg-black rounded-xl p-3 flex items-center gap-3 relative overflow-hidden shadow-sm border border-zinc-800">
        <div className="bg-[var(--primary)] p-2 flex items-center justify-center rounded-lg text-white shadow-sm z-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-3.5 shadow-sm hover:border-[var(--primary)] transition-colors">
          ...
          <div className="text-xl font-black text-zinc-900 dark:text-zinc-50">185,420</div>
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-3.5 shadow-sm hover:border-[var(--primary)] transition-colors">
          ...
          <div className="text-xl font-black text-zinc-900 dark:text-zinc-50">14.2M</div>
          <p className="text-[10px] font-semibold text-zinc-500 mt-2.5">Points liability across system</p>
        </div>
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-3.5 shadow-sm hover:border-[var(--primary)] transition-colors">
          <div className="flex justify-between items-start mb-2.5">
            ...
            <span className="text-rose-600 dark:text-rose-500 font-bold text-[10px] flex items-center gap-0.5 bg-rose-50 dark:bg-rose-955/30 px-1.5 py-0.5 rounded">
              <TrendingDown size={12} /> -4%
            </span>
          </div>
          <div className="text-xl font-black text-zinc-900 dark:text-zinc-50">2.85M</div>
          <p className="text-[10px] font-semibold text-zinc-500 mt-2.5">Estimated ₹35L value</p>
        </div>
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-3.5 shadow-sm hover:border-[var(--primary)] transition-colors">
          ...
          <div className="text-xl font-black text-zinc-900 dark:text-zinc-50">68.4%</div>
          <div className="flex gap-1 mt-3">
            <div className="h-1 rounded-full flex-1 bg-[var(--primary)]"></div>
            <div className="h-1 rounded-full flex-1 bg-[var(--primary)]"></div>
            <div className="h-1 rounded-full flex-1 bg-zinc-100 dark:bg-zinc-800"></div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-2 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-3.5 shadow-sm">
          ...
          <div className="h-[180px] flex items-end gap-2 relative">
            ...
            {/* X-Axis Labels */}
            <div className="absolute bottom-[-18px] w-full flex justify-between px-1 text-[9px] font-bold text-zinc-400 uppercase tracking-wider">
              <span>MAY 01</span>
              <span>MAY 08</span>
              <span>MAY 15</span>
              <span>MAY 22</span>
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-3.5 shadow-sm">
          ...
          <div className="relative flex justify-center mb-5">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              <span className="text-xl font-black text-zinc-900 dark:text-zinc-50">185k</span>
              <span className="text-[9px] font-bold uppercase tracking-wider text-zinc-500">Members</span>
            </div>
          </div>
          <div className="space-y-2 text-xs">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="font-mono text-zinc-500">25%</span>
            </div>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-1.5">
      ...
      <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl shadow-sm overflow-hidden mb-4">
        <div className="px-4 py-3 border-b border-zinc-200 dark:border-zinc-800 flex justify-between items-center bg-zinc-50/50 dark:bg-zinc-950/50">
          <h3 className="text-sm font-bold text-zinc-900 dark:text-zinc-50">Top Loyalty Customers</h3>
          <button className="text-[var(--primary)] font-bold text-[9px] uppercase tracking-wider flex items-center gap-0.5 hover:underline">
            View Leaderboard
            <ArrowRight size={12} />
          </button>
        </div>
          ...
          <table className="w-full text-left text-xs">
            <thead>
              <tr className="bg-zinc-50 dark:bg-zinc-950 border-b border-zinc-200 dark:border-zinc-800">
                <th className="px-3 py-2 text-[10px] font-bold text-zinc-500 uppercase tracking-wider">Rank</th>
                <th className="px-3 py-2 text-[10px] font-bold text-zinc-500 uppercase tracking-wider">Name</th>
                <th className="px-3 py-2 text-[10px] font-bold text-zinc-500 uppercase tracking-wider">Points Balance</th>
                <th className="px-3 py-2 text-[10px] font-bold text-zinc-500 uppercase tracking-wider">Tier</th>
                <th className="px-3 py-2 text-[10px] font-bold text-zinc-500 uppercase tracking-wider">Last Activity</th>
            ...
            <tbody className="divide-y divide-zinc-100 dark:divide-zinc-800/50">
              {[
                ...
                <tr key={i} className="hover:bg-zinc-50 dark:hover:bg-zinc-800/20 transition-colors text-xs">
                  <td className="px-3 py-2 font-mono font-bold text-[var(--primary)]">{cust.rank}</td>
                  <td className="px-3 py-2">
                    <div className="flex items-center gap-2">
                      <div className={`w-7 h-7 rounded flex items-center justify-center font-bold text-[10px] ${cust.color}`}>
                        {cust.init}
                      </div>
                      <span className="font-bold text-zinc-900 dark:text-zinc-100">{cust.name}</span>
                    </div>
                  </td>
                  <td className="px-3 py-2 font-mono font-black text-zinc-900 dark:text-zinc-100">{cust.points}</td>
                  <td className="px-3 py-2">
                    <span className="px-2 py-0.5 text-[9px] font-bold uppercase tracking-wider rounded bg-[var(--primary)] text-white">
                      {cust.tier}
                    </span>
                  </td>
                  <td className="px-3 py-2 font-medium text-zinc-500 dark:text-zinc-400">{cust.activity}</td>
                  <td className="px-3 py-2 text-right">
                    <button className="p-1 hover:bg-zinc-100 dark:hover:bg-zinc-800 rounded text-zinc-400 hover:text-zinc-600 dark:hover:text-zinc-300 transition-colors">
