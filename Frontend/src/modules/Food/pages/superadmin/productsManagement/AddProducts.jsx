    ...
    <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/50 backdrop-blur-sm animate-in fade-in duration-200 p-4">
      ...
      <div className="flex flex-col bg-white dark:bg-zinc-950 overflow-hidden w-full h-full md:max-w-3xl md:h-[85vh] md:max-h-[800px] md:shadow-2xl md:rounded-xl">
        ...
        <main className="flex-1 overflow-y-auto px-4 py-8 md:px-8 scrollbar-thin scrollbar-thumb-zinc-300 dark:scrollbar-thumb-zinc-700">
          ...
          {currentStep === 1 && (
            <form className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300" id="step-1-form">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="col-span-1 md:col-span-2">
                  ...
                  <input
                    className="w-full h-12 px-4 border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-900 rounded-lg focus:ring-2 focus:ring-[var(--primary)]/20 focus:border-[var(--primary)] outline-none transition-all text-sm text-zinc-900 dark:text-zinc-100 placeholder-zinc-400 dark:placeholder-zinc-500"
          ...
          {/* Step 2: Pricing */}
          {currentStep === 2 && (
            <div className="max-w-2xl mx-auto flex flex-col gap-8 animate-in fade-in slide-in-from-right-4 duration-300">
              {/* Base Price */}
              <section className="flex flex-col gap-3">
                ...
                <div className="relative">
                  ...
                  <input
                    className="w-full pl-10 pr-4 py-3 border border-zinc-300 dark:border-zinc-700 rounded-lg focus:ring-2 focus:ring-[var(--primary)]/20 focus:border-[var(--primary)] outline-none bg-white dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 transition-all font-medium placeholder-zinc-400 dark:placeholder-zinc-500"
                    id="base_price"
                    placeholder="249.00"
                    type="number"
                  />
              ...
              <section className="flex flex-col gap-3">
                ...
                <select
                  className="w-full px-4 py-3 border border-zinc-300 dark:border-zinc-700 rounded-lg bg-white dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 focus:ring-2 focus:ring-[var(--primary)]/20 focus:border-[var(--primary)] outline-none transition-all font-medium"
                  id="tax_rate"
                  defaultValue="12"
                >
              ...
              <section className="flex flex-col gap-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="flex flex-col gap-2">
                    <span className="text-xs font-bold uppercase text-zinc-500 tracking-wider">Small</span>
                    <div className="relative">
                      <span className="absolute left-3 top-1/2 -translate-y-1/2 text-xs font-bold text-zinc-500">₹</span>
                      <input
                        className="w-full pl-8 pr-3 py-2.5 border border-zinc-300 dark:border-zinc-700 rounded-lg bg-white dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 focus:ring-2 focus:ring-[var(--primary)]/20 focus:border-[var(--primary)] outline-none transition-all font-medium placeholder-zinc-400 dark:placeholder-zinc-500"
                        id="small_price"
                        type="number"
                        placeholder="0.00"
                      />
                  ...
                  <div className="flex flex-col gap-2">
                    <span className="text-xs font-bold uppercase text-zinc-500 tracking-wider">Medium</span>
                    <div className="relative">
                      <span className="absolute left-3 top-1/2 -translate-y-1/2 text-xs font-bold text-zinc-500">₹</span>
                      <input
                        className="w-full pl-8 pr-3 py-2.5 border border-zinc-300 dark:border-zinc-700 rounded-lg bg-white dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 focus:ring-2 focus:ring-[var(--primary)]/20 focus:border-[var(--primary)] outline-none transition-all font-medium placeholder-zinc-400 dark:placeholder-zinc-500"
                  ...
                  <div className="flex flex-col gap-2">
                    <span className="text-xs font-bold uppercase text-zinc-500 tracking-wider">Large</span>
                    <div className="relative">
                      <span className="absolute left-3 top-1/2 -translate-y-1/2 text-xs font-bold text-zinc-500">₹</span>
                      <input
                        className="w-full pl-8 pr-3 py-2.5 border border-zinc-300 dark:border-zinc-700 rounded-lg bg-white dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 focus:ring-2 focus:ring-[var(--primary)]/20 focus:border-[var(--primary)] outline-none transition-all font-medium placeholder-zinc-400 dark:placeholder-zinc-500"
            ...
            <div className="max-w-2xl mx-auto flex flex-col gap-8 animate-in fade-in slide-in-from-right-4 duration-300">
              <div className="bg-white dark:bg-zinc-900 p-8 rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-sm">
                <div className="flex items-center justify-between mb-8">
                  <div>
                    <h3 className="text-xl font-bold text-zinc-900 dark:text-zinc-100">Inventory Tracking</h3>
                    <p className="text-sm text-zinc-500 dark:text-zinc-400 mt-1">Enable tracking to manage stock levels and receive alerts.</p>
                  </div>
                  <div className="relative inline-block w-12 h-6 transition duration-200 ease-in cursor-pointer">
                    <input
                      defaultChecked
                      className="peer absolute w-6 h-6 rounded-full bg-white border-4 border-zinc-300 dark:border-zinc-600 appearance-none cursor-pointer outline-none transition-all duration-200 z-10 checked:translate-x-6 checked:border-[var(--primary)]"
                      id="inventory-toggle"
                      type="checkbox"
                    />
                    <label
                      className="block overflow-hidden h-6 rounded-full bg-zinc-300 dark:bg-zinc-700 cursor-pointer transition-colors duration-200 peer-checked:bg-[var(--primary)]"
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <input
                      className="w-full px-4 py-3 border border-zinc-300 dark:border-zinc-700 rounded-lg focus:ring-2 focus:ring-[var(--primary)]/20 focus:border-[var(--primary)] outline-none bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 transition-all font-medium placeholder-zinc-400 dark:placeholder-zinc-500"
                      id="initial-stock"
                      placeholder="150"
                      type="number"
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      type="number"
                    />
                    <p className="text-xs text-zinc-500 italic mt-1">Triggers a reorder suggestion when stock falls below this level.</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="space-y-10">
                  ...
                  <section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {/* Option 1 */}
                      <label className="flex items-center p-4 border border-zinc-200 dark:border-zinc-700 rounded-lg cursor-pointer hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors group">
                        <input defaultChecked className="w-5 h-5 rounded border-zinc-300 dark:border-zinc-600 text-[var(--primary)] focus:ring-[var(--primary)]/20 cursor-pointer" type="checkbox" />
                      ...
                      {/* Option 2 */}
                      <label className="flex items-center p-4 border border-zinc-200 dark:border-zinc-700 rounded-lg cursor-pointer hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors group">
                        <input className="w-5 h-5 rounded border-zinc-300 dark:border-zinc-600 text-[var(--primary)] focus:ring-[var(--primary)]/20 cursor-pointer" type="checkbox" />
                        <div className="ml-4 flex-1">
                  ...
                  <section className="pt-8 border-t border-zinc-200 dark:border-zinc-800">
                    <h3 className="text-base font-bold text-zinc-900 dark:text-zinc-100 mb-6">Selection Rules</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="flex flex-col gap-2">
                        <label className="text-xs font-bold text-zinc-500 uppercase tracking-wider">Minimum Add-ons</label>
                        <input
                          className="w-full p-3 border border-zinc-300 dark:border-zinc-700 rounded-lg bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 focus:ring-2 focus:ring-[var(--primary)]/20 focus:border-[var(--primary)] outline-none transition-all font-medium placeholder-zinc-400 dark:placeholder-zinc-500"
                          min="0"
                          type="number"
                          placeholder="0"
                        />
                      ...
                      <div className="flex flex-col gap-2">
                        <label className="text-xs font-bold text-zinc-500 uppercase tracking-wider">Maximum Add-ons</label>
                        <input
                          className="w-full p-3 border border-zinc-300 dark:border-zinc-700 rounded-lg bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 focus:ring-2 focus:ring-[var(--primary)]/20 focus:border-[var(--primary)] outline-none transition-all font-medium placeholder-zinc-400 dark:placeholder-zinc-500"
                          min="1"
                          type="number"
              ...
              <div className="bg-white dark:bg-zinc-900 p-8 rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-sm">
                <div className="space-y-6">
                  <div className="space-y-4">
                    <label className="text-base font-bold text-zinc-900 dark:text-zinc-100 block">Availability</label>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <label className="flex items-start gap-3 p-4 border border-zinc-200 dark:border-zinc-700 rounded-lg cursor-pointer hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors">
                        <input
                          defaultChecked
                          className="mt-1 h-5 w-5 text-[var(--primary)] focus:ring-[var(--primary)]/20 border-zinc-300 dark:border-zinc-600 cursor-pointer"
                          name="store_option"
                          type="radio"
                          value="all"
                        ...
                        />
                        <div>
                          <span className="block text-sm font-bold text-zinc-900 dark:text-zinc-100 mb-1">Available in All Stores</span>
                          <span className="block text-xs text-zinc-500 dark:text-zinc-400">Product will be listed in every current and future store location.</span>
                        </div>
                      </label>
                      <label className="flex items-start gap-3 p-4 border border-zinc-200 dark:border-zinc-700 rounded-lg cursor-pointer hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors">
                        <input
                        ...
                        />
                        <div>
                          <span className="block text-sm font-bold text-zinc-900 dark:text-zinc-100 mb-1">Select Specific Stores</span>
                          <span className="block text-xs text-zinc-500 dark:text-zinc-400">Choose specific locations where this product should be available.</span>
                        </div>
                      </label>
                    </div>
                  </div>
                  ...
                  {showStoreTable && (
                    <div className="pt-6 border-t border-zinc-200 dark:border-zinc-800 animate-in slide-in-from-top-2 duration-300">
                      <div className="flex flex-col gap-4">
                        <div className="relative">
                          <Search size={18} className="absolute left-3 top-1/2 -translate-y-1/2 text-zinc-400" />
                          <input
                            className="w-full pl-10 pr-4 py-2 border border-zinc-300 dark:border-zinc-700 rounded-lg focus:ring-2 focus:ring-[var(--primary)]/20 focus:border-[var(--primary)] outline-none bg-zinc-50 dark:bg-zinc-950 text-sm text-zinc-900 dark:text-zinc-100 transition-all"
                            placeholder="Search store locations..."
                            type="text"
                          />
                        </div>
                        <div className="border border-zinc-200 dark:border-zinc-800 rounded-lg max-h-64 overflow-y-auto scrollbar-thin scrollbar-thumb-zinc-300 dark:scrollbar-thumb-zinc-700 bg-white dark:bg-zinc-900">
                          <div className="divide-y divide-zinc-200 dark:divide-zinc-800">
                            <label className="flex items-center justify-between p-4 hover:bg-zinc-50 dark:hover:bg-zinc-800/50 cursor-pointer transition-colors">
                              <div className="flex flex-col">
                                <span className="text-sm font-bold text-zinc-900 dark:text-zinc-100">Papa Veg Downtown</span>
                                <span className="text-xs text-zinc-500 mt-0.5">New York • Active</span>
                              </div>
                              <input defaultChecked className="h-5 w-5 rounded border-zinc-300 dark:border-zinc-600 text-[var(--primary)] focus:ring-[var(--primary)]/20 cursor-pointer" type="checkbox" />
                            </label>
                            <label className="flex items-center justify-between p-4 hover:bg-zinc-50 dark:hover:bg-zinc-800/50 cursor-pointer transition-colors">
                              <div className="flex flex-col">
                              ...
                              <input className="h-5 w-5 rounded border-zinc-300 dark:border-zinc-600 text-[var(--primary)] focus:ring-[var(--primary)]/20 cursor-pointer" type="checkbox" />
                            </label>
                            <label className="flex items-center justify-between p-4 hover:bg-zinc-50 dark:hover:bg-zinc-800/50 cursor-pointer transition-colors">
                              <div className="flex flex-col">
                                <span className="text-sm font-bold text-zinc-900 dark:text-zinc-100">Papa Veg Westside</span>
                                <span className="text-xs text-zinc-500 mt-0.5">Chicago • Maintenance</span>
                              </div>
                              <input className="h-5 w-5 rounded border-zinc-300 dark:border-zinc-600 text-[var(--primary)] focus:ring-[var(--primary)]/20 cursor-pointer" type="checkbox" />
                            </label>
                          </div>
        ...
        {/* Footer Actions */}
        <footer className="bg-zinc-50 dark:bg-zinc-900/50 p-4 border-t border-zinc-200 dark:border-zinc-800 flex justify-between items-center md:px-8">
          <button
            onClick={handleBack}
            className="md:min-w-[120px] px-6 h-12 rounded-xl border border-zinc-300 dark:border-zinc-700 text-zinc-700 dark:text-zinc-300 font-bold text-sm hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors flex items-center justify-center"
          >
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="md:min-w-[160px] px-8 h-12 rounded-xl bg-[var(--primary)] text-white font-bold text-sm shadow-md hover:brightness-110 active:scale-95 transition-all flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
            >
              {isSubmitting ? (
