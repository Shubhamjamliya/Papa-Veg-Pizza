      ...
      >
        ...
        <header className="h-16 flex items-center justify-between px-4 sm:px-6 bg-white dark:bg-zinc-900 border-b border-zinc-200 dark:border-zinc-800 z-10 shrink-0">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-bold text-zinc-900 dark:text-zinc-100">Create Add-on Group</h1>
          </div>
          <button className="bg-[var(--primary)] text-white font-bold text-sm px-6 py-2 rounded-lg hover:brightness-110 active:scale-95 transition-all shadow-sm hidden sm:block">
            Save
          </button>
        </header>

        {/* Scrollable Body */}
        <main className="flex-1 overflow-y-auto hide-scrollbar p-4 sm:p-8 space-y-6 bg-zinc-50 dark:bg-zinc-950">
          ...
          <section className="bg-white dark:bg-zinc-900 p-6 rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-1.5">
                <label className="text-sm font-medium text-zinc-500 dark:text-zinc-400" htmlFor="group-name">Group Name</label>
                <input 
                  className="w-full h-12 px-4 border-zinc-200 dark:border-zinc-800 bg-transparent dark:text-zinc-100 border rounded-lg focus:ring-2 focus:ring-[var(--primary)] focus:border-[var(--primary)] outline-none transition-all placeholder:text-zinc-400 dark:placeholder:text-zinc-600" 
                  id="group-name" 
              ...
              <div className="space-y-1.5">
                <label className="text-sm font-medium text-zinc-500 dark:text-zinc-400" htmlFor="internal-desc">Internal Description (Optional)</label>
                <input 
                  className="w-full h-12 px-4 border-zinc-200 dark:border-zinc-800 bg-transparent dark:text-zinc-100 border rounded-lg focus:ring-2 focus:ring-[var(--primary)] focus:border-[var(--primary)] outline-none transition-all placeholder:text-zinc-400 dark:placeholder:text-zinc-600" 
                  id="internal-desc" 
          ...
          <section className="bg-white dark:bg-zinc-900 p-6 rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-sm border-t-4 border-t-amber-500">
            <div className="flex items-center gap-2 mb-6">
              <Settings className="text-[var(--primary)]" size={20} />
              <h2 className="text-base font-bold text-zinc-900 dark:text-zinc-100">Selection Rules</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
              <div className="space-y-1.5">
                <label className="text-sm font-medium text-zinc-500 dark:text-zinc-400">Minimum Selections</label>
                <div className="flex items-center">
                  <button 
                    onClick={() => setMinSelections(Math.max(0, minSelections - 1))}
                    className="w-10 h-10 flex items-center justify-center border border-zinc-200 dark:border-zinc-800 rounded-l-lg hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors active:bg-zinc-100 dark:active:bg-zinc-700 text-zinc-600 dark:text-zinc-300"
                  >
                    <Minus size={16} />
                  </button>
                  <input 
                    className="w-full h-10 text-center bg-transparent border-y border-zinc-200 dark:border-zinc-800 focus:ring-0 outline-none tabular-nums dark:text-zinc-100" 
                    type="number" 
                    value={minSelections}
                  ...
                  <button 
                    ...
                    className="w-10 h-10 flex items-center justify-center border border-zinc-200 dark:border-zinc-800 rounded-r-lg hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors active:bg-zinc-100 dark:active:bg-zinc-700 text-zinc-600 dark:text-zinc-300"
                  >
                    <Plus size={16} />
                  </button>
                </div>
              ...
              <div className="space-y-1.5">
                <label className="text-sm font-medium text-zinc-500 dark:text-zinc-400">Maximum Selections</label>
                <div className="flex items-center">
                  <button 
          ...
          <section className="bg-white dark:bg-zinc-900 p-6 rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-sm min-h-[400px]">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
              <div className="flex items-center gap-2">
                <PlusCircle className="text-[var(--primary)]" size={20} />
                <h2 className="text-base font-bold text-zinc-900 dark:text-zinc-100">Toppings in Group</h2>
              </div>
              <div className="relative flex-1 sm:max-w-sm">
                <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-zinc-400" size={18} />
                <input 
                  className="w-full h-11 pl-10 pr-4 bg-zinc-50 dark:bg-zinc-800/50 border-zinc-200 dark:border-zinc-800 border rounded-full focus:ring-2 focus:ring-[var(--primary)] focus:border-[var(--primary)] outline-none text-sm dark:text-zinc-100" 
            ...
            <div className="border border-zinc-200 dark:border-zinc-800 rounded-lg overflow-hidden">
              <table className="w-full text-left border-collapse">
                <thead className="bg-zinc-50 dark:bg-zinc-800/50 text-sm font-medium text-zinc-500 dark:text-zinc-400 uppercase tracking-wider">
                  <tr>
                    <th className="px-4 py-2">Topping Name</th>
                ...
                <tbody className="divide-y divide-zinc-200 dark:divide-zinc-800">
                  ...
                  <tr className="hover:bg-[var(--primary)]/5 dark:hover:bg-zinc-800/80 transition-colors group">
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-4">
                        <div className="w-10 h-10 rounded-lg overflow-hidden flex-shrink-0 bg-zinc-100 dark:bg-zinc-800">
                          <img 
                            alt="Paneer Tikka" 
                    ...
                    <td className="px-4 py-3 tabular-nums text-zinc-500 dark:text-zinc-400">$1.50</td>
                    <td className="px-4 py-3 text-right">
                      <button aria-label="Remove" className="p-2 text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors active:scale-90">
                        <Trash2 size={18} />
                      </button>
                    </td>
                  </tr>
                  ...
                  <tr className="hover:bg-[var(--primary)]/5 dark:hover:bg-zinc-800/80 transition-colors group">
                    ...
                    <td className="px-4 py-3 tabular-nums text-zinc-500 dark:text-zinc-400">$2.00</td>
                    <td className="px-4 py-3 text-right">
                      <button aria-label="Remove" className="p-2 text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors active:scale-90">
                        <Trash2 size={18} />
                      </button>
                      ...
                      <div className="flex items-center gap-4">
                        <div className="w-10 h-10 rounded-lg overflow-hidden flex-shrink-0 bg-zinc-100 dark:bg-zinc-800">
                          <img 
                            alt="Garlic Mayo Dip" 
                            className="w-full h-full object-cover" 
                            src="https://lh3.googleusercontent.com/aida-public/AB6AXuAoBhoyqPMKUX9SQGtrdDaY29sttdfAiS9jUnKNYOwfwZymSpLO-WcFK-2NaCOOro_X4c3k_LKQSMJhrBu4E75cZlX0yQF2RZTXcabcPcxsQl97CDN2bXhy9iPDC6_NKCMrfFQcLXhiaL-7B26r6gWxbUKlwgm2pCAw5nEaGtjWice-Mys_i4UKu4hjhkcGyZkOxjMUFNTkttbAnK7AbqDUWpjynB2zPVwtod11z0NOTs8bQboZpY2wweozcd6GcxguE_wQ3Hn1ztE"
                          />
                        </div>
                        <span className="text-sm font-semibold text-zinc-900 dark:text-zinc-100">Garlic Mayo Dip</span>
                      </div>
                    </td>
                    <td className="px-4 py-3 tabular-nums text-zinc-500 dark:text-zinc-400">$0.75</td>
                    <td className="px-4 py-3 text-right">
                      <button aria-label="Remove" className="p-2 text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors active:scale-90">
                        <Trash2 size={18} />
                      </button>
            ...
            {/* Empty State Hint */}
            <div className="mt-6 flex flex-col items-center justify-center py-12 border-2 border-dashed border-zinc-200 dark:border-zinc-800 rounded-lg bg-zinc-50 dark:bg-zinc-900/50">
              <UtensilsCrossed className="text-zinc-300 dark:text-zinc-600 mb-2" size={40} />
