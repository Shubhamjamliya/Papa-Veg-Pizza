      ...
      <aside className={`fixed right-0 top-0 h-full w-full md:w-[600px] bg-white dark:bg-zinc-950 z-[70] transform transition-transform duration-300 ease-in-out shadow-2xl flex flex-col ${isOpen ? "translate-x-0" : "translate-x-full"}`}>
            ...
            <div className="space-y-6 animate-in fade-in duration-300">
              ...
              <div className="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 p-6 shadow-sm">
                <div className="flex justify-between items-start mb-6">
                  <div>
                    <h2 className="text-lg font-bold text-zinc-900 dark:text-zinc-100">Movement History</h2>
                    <p className="text-sm text-zinc-500">Real-time log for item: <span className="font-bold">{item?.id || "MOZ-001"}</span></p>
                  </div>
                  <button className="flex items-center gap-2 bg-white dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-700 px-3 py-2 rounded-lg hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors active:scale-95 text-zinc-700 dark:text-zinc-300">
                    <Filter size={18} />
        ...
        <div className="p-6 border-t border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/50 flex flex-col sm:flex-row gap-3">
          <button 
            ...
            className="flex-1 flex items-center justify-center gap-2 py-3 bg-[var(--primary)] text-white font-bold text-sm rounded-xl shadow-md hover:brightness-110 active:scale-95 transition-all"
          >
            <Edit size={16} />
            Stock Adjustment
          </button>
