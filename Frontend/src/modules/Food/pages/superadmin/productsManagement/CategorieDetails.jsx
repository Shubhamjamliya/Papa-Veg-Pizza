      ...
      >
        ...
        <div className="p-6 border-b border-zinc-200 dark:border-zinc-800 flex justify-between items-center bg-zinc-50 dark:bg-zinc-900/50">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 bg-red-100 dark:bg-red-900/30 rounded-xl flex items-center justify-center text-red-600 dark:text-red-500">
              <Pizza size={24} />
            </div>
            <div>
          ...
          <button 
            className="w-10 h-10 rounded-full hover:bg-zinc-200 dark:hover:bg-zinc-800 flex items-center justify-center text-zinc-500 transition-colors"
            onClick={onClose}
          >
            <X size={20} />
          </button>
        ...
        {/* Drawer Tabs */}
        <div className="flex px-6 bg-zinc-50 dark:bg-zinc-900/50 border-b border-zinc-200 dark:border-zinc-800 overflow-x-auto gap-6 hide-scrollbar">
          {[
            ...
            <button
              ...
              className={`py-4 text-xs font-bold uppercase tracking-widest whitespace-nowrap transition-colors ${
                activeTab === tab.id 
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-8">
            ...
            <div className="flex flex-col gap-6 animate-in fade-in duration-300">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="col-span-full">
                  ...
                  <div className="relative w-full h-48 rounded-xl overflow-hidden border border-zinc-200 dark:border-zinc-800 bg-zinc-100 dark:bg-zinc-900">
                    <img 
                    ...
                    <div className="absolute bottom-4 right-4">
                      <button className="bg-white/90 dark:bg-zinc-900/90 backdrop-blur px-4 py-2 rounded-full text-xs font-bold text-[var(--primary)] border border-[var(--primary)]/20 flex items-center gap-2 hover:bg-white dark:hover:bg-zinc-900 transition-colors shadow-sm">
          ...
          {activeTab === "hierarchy" && (
            <div className="flex flex-col gap-6 animate-in fade-in duration-300">
              ...
              <div className="p-6 border border-zinc-200 dark:border-zinc-800 rounded-xl bg-zinc-50 dark:bg-zinc-900/50 flex flex-col gap-4">
                <div className="flex items-center gap-4">
                  <FolderOpen className="text-[var(--primary)]" size={20} />
                  <span className="text-base font-bold text-zinc-900 dark:text-zinc-100">Root Category (Menu)</span>
                </div>
                <div className="ml-6 border-l-2 border-zinc-200 dark:border-zinc-800 pl-6 space-y-4">
                  <div className="flex items-center gap-4">
                    <Pizza className="text-[var(--primary)]" size={20} />
                    <span className="text-base font-bold text-[var(--primary)]">{category?.name || "Pizza"}</span>
                  </div>
                  <div className="ml-6 border-l-2 border-zinc-200 dark:border-zinc-800 pl-6 space-y-4">
                    <div className="flex items-center gap-4">
              ...
              <div className="border border-zinc-200 dark:border-zinc-800 rounded-xl overflow-hidden shadow-sm">
                <table className="w-full text-left">
                  <thead className="bg-zinc-50 dark:bg-zinc-900/80 border-b border-zinc-200 dark:border-zinc-800">
                    <tr>
                      <th className="px-4 py-3 text-xs font-bold text-zinc-500">Product</th>
                      <th className="px-4 py-3 text-xs font-bold text-zinc-500">SKU</th>
                  ...
                  <tbody className="divide-y divide-zinc-200 dark:divide-zinc-800 bg-white dark:bg-zinc-950">
                    <tr className="hover:bg-zinc-50 dark:hover:bg-zinc-900 transition-colors">
                      <td className="px-4 py-3 text-sm text-zinc-800 dark:text-zinc-200">Margherita Classic</td>
                      <td className="px-4 py-3 text-sm font-mono text-zinc-500">PZ-MAR-001</td>
                      <td className="px-4 py-3 text-sm font-bold text-zinc-800 dark:text-zinc-200">₹249</td>
                    </tr>
                    <tr className="hover:bg-zinc-50 dark:hover:bg-zinc-900 transition-colors">
                      <td className="px-4 py-3 text-sm text-zinc-800 dark:text-zinc-200">Garden Fresh Veggie</td>
                      <td className="px-4 py-3 text-sm font-mono text-zinc-500">PZ-VEG-002</td>
                      <td className="px-4 py-3 text-sm font-bold text-zinc-800 dark:text-zinc-200">₹299</td>
                    </tr>
                    <tr className="hover:bg-zinc-50 dark:hover:bg-zinc-900 transition-colors">
                      <td className="px-4 py-3 text-sm text-zinc-800 dark:text-zinc-200">Double Cheese Burst</td>
                      <td className="px-4 py-3 text-sm font-mono text-zinc-500">PZ-CHZ-003</td>
                      <td className="px-4 py-3 text-sm font-bold text-zinc-800 dark:text-zinc-200">₹349</td>
                    </tr>
                  </tbody>
                </table>
              </div>
        ...
        <div className="p-6 border-t border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/50 flex flex-wrap justify-between gap-4">
          <button 
            className="px-6 py-2 border border-zinc-300 dark:border-zinc-700 rounded-xl text-sm font-bold text-zinc-700 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors bg-white dark:bg-zinc-950 shadow-sm"
            onClick={onClose}
          >
            Close
          </button>
          <div className="flex gap-4">
            <button className="px-6 py-2 border border-[var(--primary)] text-[var(--primary)] rounded-xl text-sm font-bold hover:bg-[var(--primary)]/5 transition-colors bg-white dark:bg-zinc-950 shadow-sm">
              Manage Products
            </button>
            <button className="px-6 py-2 bg-[var(--primary)] text-white rounded-xl text-sm font-bold hover:brightness-110 active:scale-95 transition-all flex items-center gap-2 shadow-md">
