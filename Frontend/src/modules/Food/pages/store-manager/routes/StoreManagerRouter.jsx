        ...
        >
          ...
          <Route 
            ...
            element={
              <PagePlaceholder 
                title="Ready Orders" 
                description="Items completed, boxed, and ready for pickup or rider assignment" 
          ...
          <Route 
            ...
            element={
              <PagePlaceholder 
                title="Kitchen Queue" 
                description="Live cooking backlog and preparation pipeline" 
                allowedRoles={["store_manager", "kitchen_supervisor", "kitchen_staff"]}
              />
            } 
          />
          ...
          <Route 
            ...
            element={
              <PagePlaceholder 
                ...
                description="Pizza slicing, quality checks, packaging, and label printing" 
                allowedRoles={["store_manager", "kitchen_supervisor", "kitchen_staff"]}
              />
            } 
          />
