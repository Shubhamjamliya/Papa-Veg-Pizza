  ...
  return (
    <div className="min-h-screen bg-white font-poppins pb-32">
       ...
       <div className="bg-[#121212] border-b border-white/10 px-6 py-3 flex items-center justify-between sticky top-0 z-[100] backdrop-blur-2xl">
          ...
          <button onClick={() => setShowBonusModal(true)} className="w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center text-primary border border-primary/20 relative active:scale-90 transition-all">
       ...
       <div className="px-4 py-2 space-y-5">
          ...
          <div className="bg-primary/10 rounded-2xl p-6 border border-primary/20 flex justify-between items-center">
             <div>
                      ...
                      <div key={trip.orderId || idx} className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm active:scale-[0.99] transition-all">
                         <div className="flex justify-between items-start mb-2">
                             <div>
                                ...
                                <p className="text-sm font-medium text-gray-500 mt-0.5">{trip.store || trip.storeName || 'Sayaji'}</p>
                         ...
                         <div className="flex gap-2 mb-4 mt-3">
                             <span className={`text-[10px] font-bold px-3 py-1 rounded-full ${(isCOD || isQR) ? 'bg-orange-50 text-orange-600' : 'bg-secondary/10 text-secondary'}`}>
                   ...
                   <div className="flex-1 overflow-y-auto pr-1 space-y-4">
                      {bonusLoading ? (
                         ...
                         <div key={i} className="bg-gray-50 rounded-2xl p-5 border border-gray-100 flex justify-between items-center">
                            ...
                            <span className="bg-primary/10 text-primary text-[10px] font-bold px-3 py-1 rounded-full uppercase">DELIVERED</span>
                         </div>
                      )) : (
                         <div className="py-20 text-center flex flex-col items-center">
