...
import storeAdminRoutes from '../modules/food/admin/routes/admin.routes.js';
...
router.use('/v1/food/notifications', authMiddleware, requireRoles('USER', 'STORE', 'DELIVERY_PARTNER'), notificationRoutes);
