 ...
 * Every credit/debit across all entity types (user, store, deliveryBoy, admin)
...
const transactionSchema = new mongoose.Schema(
    {
        ...
        entityType: {
            type: String,
            enum: ['user', 'store', 'deliveryBoy', 'admin'],
            required: true,
            index: true
        },
        /** ObjectId of the entity (userId, storeId, deliveryPartnerId, or admin id) */
        entityId: {
            type: mongoose.Schema.Types.ObjectId,
            required: true,
            index: true
